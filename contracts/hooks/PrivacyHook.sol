 ...
 */
contract PrivacyHook is BaseERC8183Hook, IERC8183HookMetadata {
    ...
    /// @notice Empty by default to match BiddingHook / FundTransferHook convention.
    ///         When used via MultiHookRouter, clients must configure the hook on
    ///         at least the setBudget and submit selectors; otherwise _preSubmit
    ///         reverts with PrivacyNotConfigured at runtime.
